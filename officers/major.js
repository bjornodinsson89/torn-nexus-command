...
(function() {
    ...
    const Major = {
        ...
        buildInterface: function() {
            ...
            // 2. Inject Styles (Helper function at bottom)
            ...
            drawer.innerHTML = `
                ...
                <div class="fwh-panel">
                    <div class="chain-hud">
                        <div class="chain-title">CHAIN <span id="dash-chain-timer">00:00</span></div>
                        <div class="chain-bar">
                            <div class="chain-bar-fill" id="dash-chain-fill" style="width: 0%"></div>
                            <div class="chain-bar-text" id="dash-chain-text">0 / 0</div>
                        </div>
                    </div>
        ...
        renderSlider: function(key, label, colorClass) {
            ...
            // Calculate percentage for CSS (Max 300s / 5 mins)
        ...
        initSliders: function() {
            ...
            tracks.forEach(track => {
                ...
                knob.addEventListener('pointerup', (e) => {
                    ...
                    // console.log(`[MAJOR] Saved ${key}: ${finalSeconds}s`);
                });
            });
        },
