 ...
 * BASE: WarGUI v1.8 (User Provided)
 */
...
(function() {
    ...
    const Major = {
        ...
        init: function(General) {
            ...
            console.log("🛡️ [MAJOR] Initializing WarGUI v1.8...");
            ...
            // 4. Listen for Data (The connection to Lieutenant)
            ...
            console.log("🛡️ [MAJOR] Ready.");
        },

        // ========================================================
        // DATA BINDING (Updates the UI with real numbers)
        // ========================================================
        updateUI: function(data) {
            ...
            if (data.chain) {
                ...
                if (data.chain.current > 0) {
                    const pct = (data.chain.current / data.chain.maximum) * 100;
                    if(barFill) barFill.style.width = pct + "%";
                    if(barText) barText.textContent = `${data.chain.current} / ${data.chain.maximum}`;
                    if(timer) timer.textContent = `${data.chain.timeout}s`;
                } else {
        ...
        // ========================================================
        // STORAGE (Replaces GM_ functions for Module compatibility)
        // ========================================================
        ...
        createDashboardPanel: function() {
            ...
            // ADDED IDs HERE so we can update the text!
            el.innerHTML = `
        ...
        handleGlobalClicks: function(e) {
            ...
            if(link) {
                const dest = link.textContent.toLowerCase();
                if(dest === "gym") window.location.href = "https://www.torn.com/gym.php";
                if(dest === "crimes") window.location.href = "https://www.torn.com/crimes.php";
                if(dest === "jail") window.location.href = "https://www.torn.com/jailview.php";
                if(dest === "items") window.location.href = "https://www.torn.com/item.php";
                if(dest === "hospital") window.location.href = "https://www.torn.com/hospitalview.php";
                if(dest === "armory") window.location.href = "https://www.torn.com/armory.php";
            }
        },
        ...
        // ========================================================
        // RESIZE LOGIC (Raf & 1:1) - Exact Copy
        // ========================================================
        initResizeLogic: function() {
            ...
            const onPointerDown = (m, e) => {
                ...
                startW = drawer.offsetWidth; startH = drawer.offsetHeight;
                    ...
                    <div class="settings-group">
                        ...
                        <div class="setting-row">
                             ...
                             <div style="flex:1;display:flex;flex-direction:column;gap:4px;">
                                 <input class="fwh-modal-input" type="text" value="${apiKey ? apiKey : 'Managed by Nexus'}" disabled>
                             </div>
                        </div>
                    </div>
                </div>`;
        ...
        showInitialApiPopupIfNeeded: function(){
            ...
            if (existing) return;
            // Simplified prompt since General usually handles this now
            const key = prompt("Enter API Key (Nexus):");
            if(key) localStorage.setItem('WAR_API_KEY', key);
        },
